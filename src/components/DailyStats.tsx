...
export function DailyStats({ calories, carbohydrates, fats, proteins }: IGoalArcsProps) {
  return (
    <View className='items-center justify-center'>
      <View className='items-center relative min-h-[172px]'>
        ...
        <View className='-mt-16 items-center justify-center'>
          ...
          <Text className='text-gray-700 mt-1 text-center font-sans-regular text-sm'>Calorias</Text>
        </View>
      </View>
